...
iOS app prototype — ranked sports picks, daily closest-pick tournament, groups, and profile badges.
...
The app can highlight a couple of props each **UTC calendar day** with a **1.5×** payout multiplier on the displayed decimal odds (the prototype picks them deterministically from dev data).
